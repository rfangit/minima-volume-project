...
class CIFAR10_CNN(nn.Module):
    def __init__(
        ...
        self.conv_channels = conv_channels or [32, 64, 128]  # Increased channels for CIFAR
        self.kernel_size = kernel_size
        self.fc_dims = fc_dims or [512, 256]  # Adjusted FC dimensions
    ...
    def _initialize_layers(self):
        layers = []
        in_channels = 3  # CIFAR-10 has 3 input channels (RGB)
        ...
        for h in self.fc_dims:
            ...
            input_dim = h
        fc_layers.append(nn.Linear(input_dim, 10))  # CIFAR-10 has 10 classes
